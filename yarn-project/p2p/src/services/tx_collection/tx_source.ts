...
import type { SharedTxValidationCache } from './shared_tx_validation_cache.js';
...
export class NodeRpcTxSource implements TxSource {
  constructor(
    ...
    private readonly validationCache: SharedTxValidationCache,
    private readonly info: string,
  ) {}

  public static fromUrl(
    nodeUrl: string,
    validationCache: SharedTxValidationCache,
